...
export const MyOrdersModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      ...
      {/* Modal Card */}
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden z-10 animate-slide-up border border-slate-200/90 my-auto flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Track real-time XYVOT approvals, pickup times, and download GST tax invoices.
              </p>
            </div>
          </div>
            ...
            orders.map((ord) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 hover:border-emerald-300 transition-colors shadow-xs"
                >
                  {/* Order Top Bar */}
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-100 pb-2.5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold bg-slate-900 hover:bg-black text-white shadow-xs transition-all active:scale-95 cursor-pointer"
                      >
                  ...
                  {ord.items && ord.items.length > 0 && (
                    <div className="space-y-1.5 text-xs text-slate-600 bg-slate-50/50 p-2.5 rounded-lg border border-slate-100">
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-slate-100 text-xs">
                    <span className="text-slate-500 font-medium">
                      Payment Mode: <strong className="text-slate-700">{ord.payment_method || 'Cash on Delivery (COD)'}</strong>
                    </span>
