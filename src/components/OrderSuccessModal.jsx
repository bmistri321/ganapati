...
import { CheckCircle2, Download, ArrowRight, Smartphone, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      ...
      <div className="relative bg-white rounded shadow-2xl max-w-lg w-full overflow-hidden z-10 animate-slide-up border border-slate-200/90 my-auto p-6 sm:p-8 text-center space-y-6">
        ...
        <div className="p-3.5 rounded bg-emerald-50/90 border border-emerald-200 text-xs text-emerald-900 flex items-center justify-center gap-2 text-left shadow-xs">
        ...
        <div className="space-y-2.5">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-bold py-3.5 px-4 rounded text-xs uppercase tracking-wider transition-all shadow-md active:scale-98 cursor-pointer"
          >
          ...
          <button
            onClick={onClose}
            className="w-full inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded bg-slate-100 hover:bg-slate-200 text-xs font-bold text-slate-800 transition-colors cursor-pointer"
          >
